 ...
 */
public class FileTransferClientNodePlugin extends Plugin {
    // The shared instance.
    private static FileTransferClientNodePlugin plugin;

    /**
     * The constructor.
     */
    public FileTransferClientNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FileTransferClientNodePlugin getDefault() {
        return plugin;
    }
